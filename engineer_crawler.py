...
page = requests.get(urls["공과대학공지"]["url"])
soup = BeautifulSoup(page.content, 'html.parser')

titles = soup.find_all(urls["공과대학공지"]["title"]["tag"],{"class" : urls["공과대학공지"]["title"]["class"]})
dates = soup.find_all(urls["공과대학공지"]["date"]["tag"],{"class" : urls["공과대학공지"]["date"]["class"]})
