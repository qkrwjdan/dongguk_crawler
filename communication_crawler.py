...
page = requests.get(urls["정보통신공학과공지"]["url"],verify=False)
soup = BeautifulSoup(page.content, 'html.parser')

titles = soup.find_all(urls["정보통신공학과공지"]["title"]["tag"],{"class" : urls["정보통신공학과공지"]["title"]["class"]})
dates = soup.find_all(urls["정보통신공학과공지"]["date"]["tag"],{"class" : urls["정보통신공학과공지"]["date"]["class"]})
